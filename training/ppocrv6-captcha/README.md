...
- PaddlePaddle target: `3.2.0`, Linux x86_64 with a supported NVIDIA CUDA stack
...
Use a dedicated Python 3.10 environment. Install the CUDA build of PaddlePaddle 3.2.0 from the command generated by the official PaddlePaddle installation selector for the host's CUDA version, then install PaddleOCR's pinned requirements. Do not substitute an unrecorded PaddleOCR revision.
...
- Apple M4 Chrome and Edge recognition-only warm P95 is at most 100 ms; cold start and memory are recorded.
